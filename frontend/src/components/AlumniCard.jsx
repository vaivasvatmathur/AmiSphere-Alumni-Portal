    ...
    <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-soft">
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          <Link to={`/alumni/${alumni._id}`} className="font-semibold text-slate-950 hover:text-brand-700">
            {alumni.fullName}
          </Link>
      ...
      <div className="mt-5 flex items-center gap-2 border-t border-slate-100 pt-4">
        {alumni.linkedinUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-lg bg-[#0a66c2] px-3 py-2 text-xs font-semibold text-white hover:bg-[#084f96]"
          >
            <Linkedin size={15} />
            LinkedIn
          </a>
